  ...
  async approveOrDecline(email: string, action: string, id: string) {
    ...
    if (action === 'approve') {
      await this._notificationService.sendEmail(
        agency?.user?.email!,
        'Your Agency has been approved and added to PlanetPost 🚀',
        `
<html lang="en">
...
<head>
    ...
    <title>Your Agency has been approved and added to PlanetPost 🚀</title>
</head>

<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been added to PlanetPost!<br />
  It will appear in the agency directory within the next 24 hours.<br /><br />
</body>
</html>`
      );
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been declined from PlanetPost!<br />
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; margin-top: 20px; border: 1px solid #ddd;">
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #000;">
                <p style="color: #fff;">Agency ID: ${agency.id}</p>
                <p style="color: #fff;">Use the admin panel to approve or decline this agency.</p>
            </td>
        </tr>
        <tr>
